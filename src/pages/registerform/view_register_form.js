import { Paper,Grid, Typography,Stack, Button, TextField, Alert, Dialog, DialogContent, DialogContentText, DialogActions } from "@mui/material";
                       ...
                       <Grid  container justifyContent="center">
                        ...
                        <Typography variant="h2"> Registro</Typography>
                         ...
                         <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <Grid container justifyContent="center">
                                         <TextField variant="filled"  label="Contraseña"     margin="normal" type={"password"} sx={{minWidth:450}}
                                         {...register('Password',{
                                             required:true,
                                ...
                                <Grid container justifyContent="center">
                                         <TextField variant="filled"  label="Repetir Contraseña"     margin="normal" type={"password"} sx={{minWidth:450}}
                                ...
                                <Grid container justifyContent={"space-around"}>
                                       ...
                                       <Button variant="contained" size="large" onClick={onclear}>Cancelar</Button>
